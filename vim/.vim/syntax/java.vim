...
" Java Swing
syn keyword javaKnownClasses        JOptionPane JPanel JFrame JEditorPane JScrollPane JFileChooser JButton ImageIcon JToolBar ActionEvent

" Java AWT
syn keyword javaKnownClasses        Color QuadCurve2D MouseWheelListener MouseMotionListener MouseListener Point Graphics Graphics2D BorderLayout FlowLayout ActionListener

" Java Type
syn keyword javaKnownClasses        String System QuadCurve2D Integer

" Java Math
syn keyword javaKnownClasses        BigDecimal MathContext

"Java Exceptions
syn keyword javaKnownClasses        Exception IOException IndexOutOfBoundsException IllegalArgumentException

" Java IO
syn keyword javaKnownClasses        InputStreamReader BufferedReader PrintStream File FileInputStream InputStream FileWriter BufferedWriter PrintWriter

" Java NET
syn keyword javaKnownClasses        URL URLEncoder HttpURLConnection Socket ServerSocket

" Java Util
syn keyword javaKnownClasses        Vector Map Calendar HashMap TreeSet HashSet ArrayList Date

" Java others
syn keyword javaKnownClasses        SimpleDateFormat

syn keyword javaAndroidClasses      Activity Context Bundle View Toast TextView Contacts ContactsContract People Cursor BroadcastReceiver Intent IntentFilter SmsManager SmsMessage Uri ContentValues SQLException SQLiteDatabase SQLiteOpenHelper ScrollView ScrollingMovementMethod Log Environment
...
syn cluster javaTop add=javaAndroidClasses,javaKnownClasses,javaExternal,javaError,javaError,javaBranch,javaLabelRegion,javaLabel,javaConditional,javaRepeat,javaBoolean,javaConstant,javaTypedef,javaOperator,javaType,javaType,javaStatement,javaStorageClass,javaAssert,javaExceptions,javaMethodDecl,javaClassDecl,javaClassDecl,javaClassDecl,javaScopeDecl,javaError,javaError2,javaUserLabel,javaLangObject,javaAnnotation,javaVarArg
...
if version >= 508 || !exists("did_java_syn_inits")
  ...
  JavaHiLink javaKnownClasses		KnownClasses
  JavaHiLink javaAndroidClasses         AndroidClasses
